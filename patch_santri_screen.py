...
file_path = 'app/src/main/java/com/example/ui/screens/SantriScreen.kt'
with open(file_path, 'r') as f:
    content = f.read()

start_index = content.find('@Composable\nfun SantriScreen(')
if start_index == -1:
    print("SantriScreen not found")
    sys.exit(1)
...
new_content = content[:start_index] + santri_code + content[end_index:]
with open(file_path, 'w') as f:
    f.write(new_content)
print("Patched SantriScreen")
