...
file_path = 'app/src/main/java/com/example/ui/screens/GenericMapelScreen.kt'
with open(file_path, 'r') as f:
    content = f.read()

start_index = content.find('@Composable\nfun CustomSubjectRombelView(')
if start_index == -1:
    print("CustomSubjectRombelView not found")
    sys.exit(1)
...
new_content = content[:start_index] + generic_code + content[end_index:]
with open(file_path, 'w') as f:
    f.write(new_content)
print("Patched GenericMapelScreen")
